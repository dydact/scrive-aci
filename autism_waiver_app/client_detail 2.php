...
/**
 * Client Detail - Autism Waiver Application
 * 
...
try {
    ...
    $recentSessions = $api->getRecentSessions($client['id'], 5);
...
<head>
    ...
    <title><?php echo htmlspecialchars($client['full_name'] ?? 'Client'); ?> - Scrive</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="btn btn-outline-light btn-sm me-2" href="clients.php">
        ...
        <div class="client-header py-4">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <h2 class="mb-1"><?php echo htmlspecialchars($client['full_name']); ?></h2>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-1">
                                    <i class="fas fa-birthday-cake me-2"></i>
                                    Age: <?php echo $client['age']; ?> years old
                                </p>
                                <p class="mb-1">
        ...
        <div class="container my-4">
            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-2">
                    <a href="new_session.php?client_uuid=<?php echo urlencode($client['uuid']); ?>" class="btn btn-primary w-100">
                        <i class="fas fa-edit me-2"></i>
                        New Progress Note
                    </a>
                </div>
                <div class="col-md-3 mb-2">
                    <a href="new_plan.php?client_uuid=<?php echo urlencode($client['uuid']); ?>" class="btn btn-success w-100">
                        ...
                        <div class="card-body">
                            <?php if (empty($plans)): ?>
                                <div class="text-center py-4 text-muted">
                                    ...
                                    <a href="new_plan.php?client_uuid=<?php echo urlencode($client['uuid']); ?>" class="btn btn-primary btn-sm">
                                        Create First Plan
                                    </a>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="card-body">
                            <?php if (empty($recentSessions)): ?>
                                <div class="text-center py-4 text-muted">
                                    ...
                                    <a href="new_session.php?client_uuid=<?php echo urlencode($client['uuid']); ?>" class="btn btn-success btn-sm">
                                ...
                                <?php foreach ($recentSessions as $session): ?>
                                    <div class="border-bottom pb-3 mb-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h6 class="mb-1">
                                                    <?php echo htmlspecialchars($session['service_type_name'] ?? $session['service_type_abbr'] ?? 'Session'); ?>
                                                </h6>
                                                <p class="text-muted small mb-1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ucfirst($client['sex'] ?? 'Unknown'); ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($client['phone_home'] ?? 'Not provided'); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                $address = trim(($client['street'] ?? '') . ' ' . ($client['city'] ?? '') . ', ' . ($client['state'] ?? '') . ' ' . ($client['postal_code'] ?? ''));
